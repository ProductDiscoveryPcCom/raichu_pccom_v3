...
def _detect_visual_elements(html_lower: str) -> List[str]:
    ...
    checks = {
        ...
        'Callout Promo': any(x in html_lower for x in ['callout-bf', 'bf-callout', 'callout_bf']),
        ...
        'Grid': any(x in html_lower for x in ['mod-grid', 'cols-2', 'cols-3']),
        'Botones CTA': any(x in html_lower for x in ['class="btn', 'class="btns', 'class="mod-cta']),
